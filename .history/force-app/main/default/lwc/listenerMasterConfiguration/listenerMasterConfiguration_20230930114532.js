...
export default class ListenerMasterConfiguration extends NavigationMixin(LightningElement) {
    ...
    async handleSubmitValidation(){
        this.isLoading = true;
        console.log('submission:' + this.selectedSObject + ' - ' + this.selectedField + ': Listener'); // format is using API names
        try {
            ...
            console.log('fieldHistoryStatus Value - '+JSON.stringify(this.fieldHistoryStatus));
