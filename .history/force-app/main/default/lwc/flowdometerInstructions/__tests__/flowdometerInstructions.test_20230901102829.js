...
const element = createElement('c-flowdometer-instructions', { is: FlowdometerInstructions });
...
jest.mock('c/modal', () => {
    return {
      ...
      default: jest.fn().mockImplementation(() => {
        return {
          // Mocking slots and properties
          name: 'mockedModal',
          // Mock any other properties you expect 'c-modal' to have.
          // Mocking events
