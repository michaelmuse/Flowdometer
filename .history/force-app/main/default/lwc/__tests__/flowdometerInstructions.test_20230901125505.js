...
let element;  // This should be mutable, considering the scope and usage
...
describe('c-flowdometer-instructions', () => {
    ...
    it('should handle the modal close event in scenario 1', () => {
    ...
    it('should handle the modal close event in scenario 2', () => {
