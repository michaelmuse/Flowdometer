...
def parse_xml_to_json(xml_file):
    print(f"Debug: Parsing {xml_file}")
...
if __name__ == "__main__":
    ...
    for dirpath, _, filenames in os.walk("force-app/main/default/objects"):
        ...
        print(f"Debug: Current directory: {dirpath}, Parent dir name: {parent_dir_name}")

        if parent_dir_name in ['Listener__c', 'Flow__c', 'Step__c'] and dir_name == 'fields':
            print(f"Debug: Entering directory: {dirpath}")
    ...
    print("Debug: Writing to JSON file")
