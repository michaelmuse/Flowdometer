...
if __name__ == "__main__":
    ...
    for dirpath, _, filenames in os.walk("force-app/main/default/objects"):
        ...
        print(f"Debug: Current directory: {dirpath}, Dir name: {dir_name}")  # Debug line

        if dir_name in ['Listener__c', 'Flow__c', 'Step__c']:
            ...
            for filename in filenames:
                if filename.endswith('.field-meta.xml'):
                    ...
                    json_output[dir_name][field_name] = parse_xml_to_json(filepath)
